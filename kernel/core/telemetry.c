...
void telemetry_emit_boot_summary(void) {
  ...
  klog(
      ...
      mutable_fs_rename_count(), mutable_fs_list_count(),
      mutable_fs_stat_count(), mutable_fs_open_count(),
