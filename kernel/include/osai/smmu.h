...
#define OSAI_SMMU_MMIO_BASE UINT64_C(0x09050000)
#define OSAI_SMMU_MMIO_PAGE1 UINT64_C(0x09060000)
#define OSAI_SMMU_MAX_STREAMS 32U
#define OSAI_SMMU_STREAM_TABLE_BYTES (OSAI_SMMU_MAX_STREAMS * 64)
#define OSAI_SMMU_CMDQ_ENTRIES 128U
#define OSAI_SMMU_CMDQ_BYTES (OSAI_SMMU_CMDQ_ENTRIES * 16)
...
typedef struct osai_smmu_stream {
  uint32_t stream_id;
  uint32_t active;
