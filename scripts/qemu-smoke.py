...
TARGETS = [
    ...
    "mutable-fs: multi-sector file self-test passed files=5 multi_sector=1",
    "mutable-fs: journal replay self-test passed replays=1 journal_writes=1",
    "mutable-fs: subsystem records self-test passed records=3",
    "mutable-fs: self-test passed files=5 directories=7 writes=8 reads=4 deletes=1 commits=1 rollbacks=1 replays=1 rejects=6 checksum_errors=0",
    ...
    "initramfs: mounted rofs version=2 files=5",
